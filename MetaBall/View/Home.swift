...
//    MARK: Clubbed One
//    Like Blob Backgorund Animation
    @ViewBuilder
            ...
            .mask {
                TimelineView(.animation(minimumInterval: 3.6, paused: false)) { _ in
                    Canvas{ context,size in
                        ...
                        //            MARK: this blur Radius determnes the amount of elasticity between two elements
    ...
    func ClubbedRoundedRectangle(offset: CGSize)-> some View{
        RoundedRectangle(cornerRadius: 30,style: .continuous)
            ...
            .offset(offset)
//        MARK: Adding animation[Less Than TtimelineView Refresh Rate]
...
//       MARK: Single MetaBall Animation
    ...
    func SingleMetaBall() -> some View {
        ...
        Rectangle()
            .fill(.linearGradient(colors: [Color("Gradient1"),Color("Gradient2")], startPoint: .top, endPoint: .bottom))
            .mask {
                //        MARK: For More Checkout out my Morphing Shapes In SwiftUI Video
